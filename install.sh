#!/usr/bin/env sh
# Universal installer for sbomx. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/sbomx.git"
echo "Installing sbomx ..."
