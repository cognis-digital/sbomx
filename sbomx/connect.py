"""Native cognis-connect emit for sbomx — forward findings to any platform.

Maps sbomx's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    sbomx ... --format json | sbomx-emit --to stix
    sbomx-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
